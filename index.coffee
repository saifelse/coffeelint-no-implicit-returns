  ...
  processFunction: (code, astApi) ->
    ...
    if expressions.length > 1 and not lastExpr.isStatement?()
      ...
      @errors.push astApi.createError
        ...
        lineNumber: lastExpr.locationData.first_line + 1
        lineNumberEnd: (lastExpr.locationData.last_line + 1 unless lastExpr.locationData.last_line == lastExpr.locationData.first_line)
